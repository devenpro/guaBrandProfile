...
(function($, Drupal) {
  ...
  // ============================================================
  // SECTION 9: V2 → V1 MIGRATION BRIDGE
  // ============================================================
  ...
  function migrateV2toV1(v2) {
    ...
    // Social profiles (array → keyed object)
    ...
    if (ops.sales) {
      v1.sales.process_stages = (ops.sales.stages || []).map(function(s, i) { return { id: generateId('stg'), stage: typeof s === 'string' ? s : s.name || '', order: i + 1 }; });
